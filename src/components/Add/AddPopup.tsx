...
export default function AddPopup(props: Props) {
  ...
  const { mutate } = api.pushUps.create.useMutation({
    ...
    onSettled: () => {
      trpc.pushUps.getAll.invalidate();
    },
  });
        ...
        >
          ...
          <div className="flex w-full flex-col  space-y-5">
              ...
              <div className="float-left w-1/2">
                {isRunning ? (
                  <button
                    ...
                    onClick={() => {
                      setStartedAt(started == true ? startedAt : new Date());
                      if (started == false) {
                        setStarted(true);
                      }
                      pause();
                  ...
                  <button className="btn-accent btn-lg  btn" onClick={start}>
            ...
            <div className="flex flex-row place-items-center space-x-3">
              ...
              <div className="w-1/2">
                <DropDown selection={select} setSelect={setSelect} />
              </div>
            </div>
            <div className="flex flex-row place-items-center space-x-3">
